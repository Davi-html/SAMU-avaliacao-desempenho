                    ...
                    <div className="px-4 py-2.5 border-b border-sidebar-border">
                        ...
                        >
                            ...
                            <svg
                                ...
                                className={`text-[#cbd5e1] transition-transform duration-200 group-hover:text-white ${filtroAberto ? "rotate-180" : ""
                                    }`}
                            >
                        ...
                        <div
                            className={`overflow-hidden transition-all duration-200 ease-in-out ${filtroAberto ? "max-h-32 opacity-100 mt-2" : "max-h-0 opacity-0"
                                }`}
                        >
                            <div className="flex flex-wrap gap-1.5 pb-1 max-h-28 overflow-y-auto custom-scrollbar pr-1">
                                <button
                                    ...
                                    className={`px-2.5 py-1 rounded-full text-[10px] font-medium border transition-all duration-150 ${selectedBases.length === 0
                                ...
                                {bases
                                    .filter((baseOption) => baseOption.nome !== "Todas as bases")
                                    .map((baseOption) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-medium border transition-all duration-150 ${ativo
                                                        ? "bg-[#cd0048] border-[#cd0048] text-white shadow-sm shadow-[#cd0048]/30"
                                                        : "bg-white/5 border-white/10 text-white/70 hover:bg-white/10 hover:border-white/20 hover:text-white"
                                                    }`}
                                            >
                    ...
                    <div className='pt-3 pb-1'>
                        ...
                        {fichasVisiveis.map((ficha) => (
                            <NavLink
                                ...
                                to={ficha.link}
                                className={({ isActive }) =>
                                    `flex items-center gap-3 px-3 py-2 rounded-lg text-xs font-medium transition-all duration-150 ml-1 ${isActive
