...
INSERT INTO public.usuarios (nome,email,cpf,funcao,perfil,base,ativo,criado_em,par,senha_master,senha) VALUES
	 ('Cisbaf','admin@admin.com','cisbaf','Médico','Administrador / CISBAF','🔑 Administrador CRUR-BF (todas as bases)',true,'2024-06-10 10:02:38.389','[{"id": 2, "nome": "Lucas", "funcao": "Condutor"}, {"id": 3, "nome": "Juliana Teste", "funcao": "Enfermeiro"}, {"id": 4, "nome": "Adm teste", "funcao": "Enfermeiro"}, {"id": 1, "nome": "Cisbaf", "funcao": "Médico"}]',false,'cisbaf'),
